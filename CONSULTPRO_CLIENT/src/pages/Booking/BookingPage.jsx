    ...
    const fetchBookedSlots = async () => {
      try {
        const response = await axios.get(
          `http://142.93.215.196.196:8001/api//appointments/get_appointment_slots_by_date_and_counselorId?appointmentDate=${
    ...
    if (orderId) {
      try {
        ...
        const response = await axios.post(
          "http://142.93.215.196.196:8001/api//appointments/create",
          {
            counselorId: selectedCounselor.id,
            clientId: userId,
