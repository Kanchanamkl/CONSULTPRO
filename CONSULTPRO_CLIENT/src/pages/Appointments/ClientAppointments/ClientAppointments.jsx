...
import AppointmentCard from "../../../components/AppointmentCard/AppointmentCard/AppointmentCard";
...
const ClientAppointments = () => {
    ...
    useEffect(() => {
      axios
        .get(`http://localhost:8080/api/appointments/get_appointments_by_clientId/?userId=${userId}`)
        .then((response) => {
    ...
    const todaySessions = appointments.filter((appointment) => isToday(appointment.date));
