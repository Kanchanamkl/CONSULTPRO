...
const BillingPopup = ({ appointmentDetails, onClose }) => {
    ...
    const { date, counselor, selectedSlot } = appointmentDetails;
    ...
    const handlePay = () => {
        ...
        const payment = {
            ...
            hash: hash,
            first_name: counselor.firstName,
            last_name: counselor.lastName,
        ...
        <div className="billing-popup">
            <div className="appointment-summary">
                ...
                <div className="summary-details">
                    ...
                    <p>
                        <span>
                            <strong>Counselor :</strong> {counselor.firstName} {counselor.lastName}
                        </span>
                    </p>
                    <p>
                        <span>
